  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      id: "1",
      sender: "agent",
      text: "Hello! I'm Kaiso AI, your agent operating system assistant. I can coordinate Phone Callers, Browser Control, and CLI pipelines for Sales Agencies and Content Creators. How can I help you execute today?",
      timestamp: "Just now",
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4 mb-12">
          ...
          <h2 className="text-3xl sm:text-5xl font-bold tracking-tight text-white leading-tight">
            Chat with Kaiso Agent OS <br className="hidden sm:inline" />
        ...
        <div className="rounded-[24px] bg-[#141419] border border-[#22222E] p-4 sm:p-6 shadow-2xl flex flex-col h-[580px] justify-between relative overflow-hidden">
          ...
          <div className="flex-1 overflow-y-auto py-4 space-y-4 pr-2">
            ...
            {isTyping && (
              ...
              >
                ...
                <span>Kaiso Agent OS is processing instructions...</span>
              </motion.div>
            )}
          ...
          >
            <input
              ...
              placeholder="Tell Kaiso Agent what to execute (e.g. 'Pitch sponsor media kit', 'Call lead Sarah')..."
